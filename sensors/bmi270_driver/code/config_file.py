...
# @File    : config_file.py
# @Description : BMI270 传感器初始化配置文件（二进制数据阵列）
# @License : MIT

# 此文件包含 BMI270 传感器上电初始化所需的 8192 字节配置数据
# 数据由 Bosch 官方提供的配置工具生成，不可手动修改
# This file contains 8192 bytes of configuration data required for BMI270 sensor
# power-up initialization. Generated by Bosch official configuration tool, do not modify.
